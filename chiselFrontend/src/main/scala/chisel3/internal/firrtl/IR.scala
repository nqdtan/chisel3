...
case class CForBegin(sourceInfo: SourceInfo, index: Arg, min: Arg, extent: Arg, stride: Arg) extends Command
case class CForEnd(sourceInfo: SourceInfo, firrtlDepth: Int) extends Command
